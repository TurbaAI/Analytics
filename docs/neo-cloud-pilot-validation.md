...
7. Use the Scheduler Simulator to compare recommended, repack, locality, and queue-SLO capacity scenarios.
...
13. Generate an eBPF host overlay with `node scripts/build-ebpf-overlay.js fixtures/ebpf-export-inputs`.
14. Validate source bundle shape with `schemas/turba-source-bundle.v1.schema.json` and the source bundle preflight checks.
