...
def _live_machine_metrics(context: dict[str, Any]) -> list[TelemetryMetric]:
    metric_specs = (
        ...
        ("gpu_memory_utilization_pct", context.get("gpuMemoryUtilizationPct")),
        ("gpu_power_watts", context.get("gpuPowerWatts")),
        ("gpu_temperature_c", context.get("gpuTemperatureC")),
        ("gpu_fan_speed_pct", context.get("gpuFanSpeedPct")),
        ("gpu_clock_mhz", context.get("gpuClockMHz")),
        ("gpu_sm_clock_mhz", context.get("gpuSmClockMHz")),
        ("gpu_memory_clock_mhz", context.get("gpuMemoryClockMHz")),
