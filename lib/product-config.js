...
function normalizeProductConfig(config, configPath = "") {
  ...
  return {
    ...
    observability: {
      prometheusUrl,
      grafanaUrl,
      grafanaDashboardUrl: observability.grafanaDashboardUrl || `${grafanaUrl}/d/turbalance-fleet-runtime/turbalance-fleet-runtime?orgId=1&from=now-1h&to=now&refresh=5s`,
