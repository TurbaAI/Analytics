...
assert.ok(html.includes("app.js?v=llm-report-20260618-1"));
assert.ok(html.includes("styles.css?v=tui-page-style-20260618-1"));
assert.ok(html.includes("app-core.js?v=llm-report-20260618-2"));
assert.ok(html.includes("app-pipeline.js?v=llm-report-20260618-3"));
assert.ok(html.includes("app-render.js?v=llm-report-20260618-3"));
