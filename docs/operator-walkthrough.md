...
- Use the optional backend ingestion service when a pilot needs signed uploads, tenant isolation, role-aware access, audit export, token/key rotation, and retention policy before the dashboard imports the accepted source bundle.
