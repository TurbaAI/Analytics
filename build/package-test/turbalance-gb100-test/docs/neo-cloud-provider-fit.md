...
- Platform security: needs controlled upload paths, tenant isolation, JWKS/JWT tenant mapping, role-aware auth, token/key rotation, metrics, audit export, and retention controls for pilot handoff.
