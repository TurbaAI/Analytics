...
6. Generate an eBPF host overlay with `node scripts/build-ebpf-overlay.js fixtures/ebpf-export-inputs`.
7. Validate source bundles against `schemas/turba-source-bundle.v1.schema.json`.
