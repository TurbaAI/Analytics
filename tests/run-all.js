...
const checks = [
  ...
  { label: "MFU and inference economics", args: ["tests/mfu-inference.test.js"] },
  ...
  { label: "savings ledger", args: ["tests/savings-ledger.test.js"] },
  { label: "savings ledger python parity", args: ["tests/savings-ledger-python.test.js"] },
  { label: "savings ledger lakehouse", args: ["tests/savings-ledger-lakehouse.test.js"] },
  { label: "action runner", args: ["tests/action-runner.test.js"] },
  ...
  { label: "benchmark commons", args: ["tests/benchmark-commons.test.js"] },
  { label: "OCP benchmark commons export", args: ["tests/ocp-benchmark-commons.test.js"] },
  { label: "turbatop TUI", args: ["tests/turbatop.test.js"] },
