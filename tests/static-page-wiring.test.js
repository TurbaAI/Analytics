...
assert.equal((html.match(/data-trend-metric="/g) || []).length, 11);
...
assert.ok(app.includes("gpuProcessInspector"));
assert.ok(app.includes("gpuThermalQualification"));
assert.ok(app.includes("gpuTopologyFingerprint"));
assert.ok(app.includes("benchmarkOcpQualificationProfile"));
assert.ok(app.includes("Qualification"));
...
assert.ok(app.includes("benchmarkOcpCommonsProfile"));
assert.ok(app.includes("benchmarkOcpCommonsPanel"));
assert.ok(app.includes("OCP Benchmark Commons"));
...
assert.ok(html.includes("app.js?v=live-telemetry-history-20260624-2"));
assert.ok(html.includes("styles.css?v=live-telemetry-history-20260624-2"));
assert.ok(html.includes("predictive-core.js?v=state-space-20260625"));
assert.ok(html.includes("app-core.js?v=live-telemetry-history-20260624-2"));
assert.ok(html.includes("app-pipeline.js?v=live-telemetry-history-20260624-2"));
assert.ok(html.includes("app-render.js?v=state-space-20260625"));
assert.ok(html.includes("machineL1L6Page"));
assert.ok(html.includes("llmReportPage"));
assert.ok(html.includes("llmApiUrl"));
assert.ok(html.includes("generateLlmReport"));
assert.ok(app.includes("buildMachineL1L6State"));
assert.ok(app.includes("buildLlmCustomerReportState"));
assert.ok(app.includes("llmReportContextFingerprint"));
assert.ok(app.includes("callLlmReportEndpoint"));
assert.ok(css.includes("llm-runtime-controls"));
assert.ok(css.includes("machine-ladder-levels"));
assert.ok(html.includes("TURBALANCE_MOBILE_CONFIG"));
...
assert.ok(css.includes("benchmark-ocp-commons"));
